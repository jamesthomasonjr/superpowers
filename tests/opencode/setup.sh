...
#   $OPENCODE_CONFIG_DIR/plugins/supersuit.js   ← symlink OpenCode reads

SUPERPOWERS_DIR="$OPENCODE_CONFIG_DIR/supersuit"
SUPERPOWERS_SKILLS_DIR="$SUPERPOWERS_DIR/skills"
SUPERPOWERS_PLUGIN_FILE="$SUPERPOWERS_DIR/.opencode/plugins/supersuit.js"
...
cp "$REPO_ROOT/.opencode/plugins/supersuit.js" "$SUPERPOWERS_PLUGIN_FILE"

# Register plugin via symlink (what OpenCode actually reads)
mkdir -p "$OPENCODE_CONFIG_DIR/plugins"
ln -sf "$SUPERPOWERS_PLUGIN_FILE" "$OPENCODE_CONFIG_DIR/plugins/supersuit.js"
...
echo "Plugin registered at: $OPENCODE_CONFIG_DIR/plugins/supersuit.js"
